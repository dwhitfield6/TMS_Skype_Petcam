...
PAGE 0 :  /* Program Memory */
   ...
   /* Part of Z1 OTP.  PSWD LOCK/CRC LOCK/ Boot Ctrl */
   DCSM_OTP_Z1_P0			: origin = 0x7800C, length = 0x000014

   /* Part of Z2 OTP.  LinkPointers */
   DCSM_OTP_Z2_LINKPOINTER	: origin = 0x78200, length = 0x00000C
   /* Part of Z2 OTP.  PSWD LOCK/CRC LOCK/ Boot Ctrl */
   DCSM_OTP_Z2_P0			: origin = 0x7820C, length = 0x000014
