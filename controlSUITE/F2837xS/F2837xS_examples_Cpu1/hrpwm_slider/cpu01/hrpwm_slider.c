...
//! will have fine edge movement due to HRPWM logic. Load the F2837xS_HRPWM_slider.gel file.
...
//====================================================================
   ...
   while (update ==1)
   {
        ...
        EPwm1Regs.CMPA.bit.CMPAHR    = DutyFine << 8;     // Left shift by 8 to write into MSB bits
        EPwm1Regs.CMPB.all        = DutyFine << 8;     // Left shift by 8 to write into MSB bits

        EPwm2Regs.CMPA.bit.CMPAHR = DutyFine << 8;     // Left shift by 8 to write into MSB bits
        EPwm2Regs.CMPB.all        = DutyFine << 8;     // Left shift by 8 to write into MSB bits
        
        // Example, 32-bit write to CMPA:CMPAHR
        EPwm3Regs.CMPA.all = ((Uint32)EPwm3Regs.CMPA.bit.CMPA << 16) + (DutyFine << 8);
        EPwm3Regs.CMPB.all        = DutyFine << 8;     // Left shift by 8 to write into MSB bits

        EPwm4Regs.CMPB.all = (DutyFine << 8);     // Left shift by 8 to write into MSB bits
        EPwm4Regs.CMPA.bit.CMPAHR = (DutyFine << 8);

         // Example, write to the HRPWM extension of CMPA / CMPB
        EPwm5Regs.CMPA.bit.CMPAHR    = DutyFine << 8;     // Left shift by 8 to write into MSB bits
        EPwm5Regs.CMPB.all        = DutyFine << 8;     // Left shift by 8 to write into MSB bits

        EPwm6Regs.CMPA.bit.CMPAHR = DutyFine << 8;     // Left shift by 8 to write into MSB bits
        EPwm6Regs.CMPB.all        = DutyFine << 8;     // Left shift by 8 to write into MSB bits

        // Example, write to the HRPWM extension of CMPA / CMPB
        EPwm7Regs.CMPA.bit.CMPAHR    = DutyFine << 8;     // Left shift by 8 to write into MSB bits
        EPwm7Regs.CMPB.all        = DutyFine << 8;     // Left shift by 8 to write into MSB bits

        EPwm8Regs.CMPA.bit.CMPAHR = DutyFine << 8;     // Left shift by 8 to write into MSB bits
        EPwm8Regs.CMPB.all        = DutyFine << 8;     // Left shift by 8 to write into MSB bits
   }
...
// ePWM5A / 5B toggle high/low with MEP control on falling edge
    ...
    EPwm5Regs.HRCNFG.bit.EDGMODE = HR_FEP;              //MEP control on falling edge
...
// ePWM6A / 6B toggle high/low with MEP control on falling edge
    ...
    EPwm6Regs.AQCTLA.bit.ZRO = AQ_SET;                  // PWM toggle high/low
...
// ePWM7A 7B  toggle high/low with MEP control on falling edge
    ...
    EPwm7Regs.TBCTL.bit.PHSEN = TB_DISABLE;                // ePWM7 is the Master
    ...
    EPwm7Regs.HRCNFG.bit.EDGMODE = HR_FEP;              //MEP control on falling edge
...
// ePWM8A 8B toggle high/low with MEP control on falling edge
    ...
    EPwm8Regs.TBCTL.bit.PHSEN = TB_DISABLE;                // ePWM8 is the Master
    ...
    EPwm8Regs.AQCTLA.bit.ZRO = AQ_SET;                  // PWM toggle high/low
    ...
    EPwm8Regs.HRCNFG.bit.EDGMODE = HR_FEP;              //MEP control on falling edge
