...
//!
//! Assuming you installed controlSUITE in the default directory, a
//! driver information (INF) file for use with Windows XP and
//! Windows 7 can be found in
//! C:/ti/controlSUITE/F2837xS/VERSION/F2837xS_common/windows_drivers.
//
//*****************************************************************************
...
GetLineCoding(tLineCoding *psLineCoding)
{
    ...
    //
    UARTConfigGetExpClk(USB_UART_BASE, SysCtlLowSpeedClockGet(SYSTEM_CLOCK_SPEED), &ui32Rate,
                            &ui32Config);
