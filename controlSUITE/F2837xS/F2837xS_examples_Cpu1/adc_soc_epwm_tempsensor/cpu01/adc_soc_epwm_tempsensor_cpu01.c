...
void SetupADCEpwm(void)
{
	...
	tempsensor_acqps = 139; //temperature sensor needs at least 700ns acquisition time

	//Select the channels to convert and end of conversion flag
	EALLOW;
	AdcaRegs.ADCSOC0CTL.bit.CHSEL = 13;  //SOC0 will convert internal connection A13
	AdcaRegs.ADCSOC0CTL.bit.ACQPS = tempsensor_acqps; //sample window is 100 SYSCLK cycles
