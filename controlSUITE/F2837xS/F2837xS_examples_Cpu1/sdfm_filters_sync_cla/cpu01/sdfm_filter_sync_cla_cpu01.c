...
void Cla_initMemoryMap(void)
{
	...
	MemCfgRegs.LSxCLAPGM.bit.CLAPGM_LS2 = 0;    //LS2RAM is configured as data memory

	/* Filter3 and Filter4 data memory LS3 */
	MemCfgRegs.LSxMSEL.bit.MSEL_LS3 = 1;    //LS3RAM is shared between CPU and CLA
	MemCfgRegs.LSxCLAPGM.bit.CLAPGM_LS3 = 0;    //LS3RAM is configured as data memory

	MemCfgRegs.LSxMSEL.bit.MSEL_LS5 = 1;    //LS5RAM is shared between CPU and CLA
	MemCfgRegs.LSxCLAPGM.bit.CLAPGM_LS5 = 1;    //LS5RAM is configured as program memory
